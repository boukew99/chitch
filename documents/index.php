...
<script>
  if ("serviceWorker" in navigator) {
    await navigator.serviceWorker.register("/script/service-worker.js");
  }
</script>
...
<header>
  ...
  <section id="download">
    ...
    <p><?= a("Download Chitch", "download.php", "class=button") ?>
    <p>Chitch is open source (<a href="https://github.com/boukew99/chitch">hosted on Github</a>) and licensed under the <a href="#license">EUPL</a>. This means you can use it for free, and you can also contribute to the project if you want.
  </section>
</header>
...
<main>
  ...
  <section id="features">
    <h2>Living Example</h2>
      <p>Chitch packs everything in a small self-contained zip file. Just extract and run. All the features on this site are included in the pack.  includes by default:
      <ul>
        <li>Guestbook
        <li>Blog
        <li>Contact page
  ...
  <section id="lightweight">
    <h2>Lightweight Pages</h2>
    <p>Pages generated by Chitch are lightweight! This translates in smaller sized package which is send over the network. This means the page loads fast but also less time is spend sending the data, thus generally using less energy. Just as in the physical world, smaller packages are easier to transport.
  </section>
  <section id="dx">
  ...
  <section id="baseline">
    ...
    <figure>
      <img src="<?= cdn('baseline-wordmark.svg') ?>" alt="baseline logo">
    </figure>
  </section>
